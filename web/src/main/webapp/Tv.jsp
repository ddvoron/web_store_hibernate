    ...
    <div id="sidebar">
        ...
        <div id="cost">
            <div class="formCost">
                ...
                <input id="commandHidden" type="hidden" value="Tv"/>
            </div>
    ...
    <div id="content">
        <div id="department">
            <div id="insideDepartment">
                <c:forEach var="good" items="${tv}">
                    <div class="element">
                        <div class="picture1">
                            <img class="picture" src="img/tv/${good.getPicture()}.jpg"/>
                        </div>
                        <div class="des1">
                            ...
                            <div class="descriptionGood"><a class="a1"
                                                            href="do?command=DescriptionTv&id=${good.getIdData()}"
                ...
                <ul class="pagination">
                    ...
                    ${page1==1?
                            "<li><a class=\"active\" href=\"do?command=Tv&page=1\">1</a></li>"
                            :
                            "<li><a href=\"do?command=Tv&page=1\">1</a></li>"}
                    ${page1==2?
                            "<li><a class=\"active\" href=\"do?command=Tv&page=2\">2</a></li>"
                            :
                            "<li><a href=\"do?command=Tv&page=2\">2</a></li>"}
                    ${page1==3?
                            "<li><a class=\"active\" href=\"do?command=Tv&page=3\">3</a></li>"
                            :
                            "<li><a href=\"do?command=Tv&page=3\">3</a></li>"}
                    ${page1==4?
                            "<li><a class=\"active\" href=\"do?command=Tv&page=4\">4</a></li>"
                            :
                            "<li><a href=\"do?command=Tv&page=4\">4</a></li>"}
                    ${page1==5?
                            "<li><a class=\"active\" href=\"do?command=Tv&page=5\">5</a></li>"
                            :
                            "<li><a href=\"do?command=Tv&page=5\">5</a></li>"}
                    ${page1==6?
                            "<li><a class=\"active\" href=\"do?command=Tv&page=6\">6</a></li>"
                            :
                            "<li><a href=\"do?command=Tv&page=6\">6</a></li>"}
                    ${page1==7?
                            "<li><a class=\"active\" href=\"do?command=Tv&page=7\">7</a></li>"
                            :
                            "<li><a href=\"do?command=Tv&page=7\">7</a></li>"}
