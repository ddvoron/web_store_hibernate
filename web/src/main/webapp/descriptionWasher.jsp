        ...
        <div id="content_descriptionF">
            <div id="inside">
                ...
                <div id="orderDuplicate">
                    <table>
                        ...
                        <tr>
                            <td id="anotherOne">
                                <div id="order" class="buttonOrder" onclick="addOrderAddW(${data.getIdData()});">Добавить в
                                    корзину
                                </div>
                            </td>
                        </tr>
            ...
            <div class="slider slider1">
                <div class="sliderContent">
                    <div class="item">
                        <img class="imgD" src="img/washer/${data.getPicture()}-1.jpg" alt=""/>
                    </div>
                    <div class="item">
                        <img class="imgD" src="img/washer/${data.getPicture()}-2.jpg" alt=""/>
                    </div>
                    <div class="item">
                        <img class="imgD" src="img/washer/${data.getPicture()}-3.jpg" alt=""/>
                    </div>
                    <div class="item">
                        <img class="imgD" src="img/washer/${data.getPicture()}-4.jpg" alt=""/>
                    </div>
                </div>
            </div>
        </div>
