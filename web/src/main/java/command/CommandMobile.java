...
/**
 * Class implements the content and functionality of the page mobile
 *
 * @author Dmitry V
 * @version 1.0
 */
public class CommandMobile implements ActionCommand {
    ...
    public String execute(HttpServletRequest request) {
        ...
        if (minCost == null && maxCost == null) {
            List<DataEntity> mobile = serviceData.getAllDataPerPage(pageNumber,
        ...
        if (FormHelper.isPost(request)) {
            if (minCost != null && maxCost != null) {
                ...
                List<DataEntity> mobile = serviceData.getAllDataPerPageAndCost(pageNumber,
